...
class JournalEntry extends HTMLElement {
  ...
  set entry(entry) {
    ...
    // console.log(entry);
    // let journal = this.template.getElementsByClass("entry")[0];
    // console.log(journal);
    // console.log(this.shadowRoot);
    // journal.getElementByClass("entry-title");
    ...
    if (entry.audio) {
      ...
      // // audioSource.src = entry.audio;
      // // audioSource.type = "audio/mp3"; // Ask TA about this

      // entryAudio.appendChild(audioSource);
